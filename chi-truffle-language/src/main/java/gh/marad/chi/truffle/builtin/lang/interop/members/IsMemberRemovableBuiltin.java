...
public class IsMemberRemovableBuiltin extends LangInteropBuiltin {
    @Child
    private InteropLibrary library;
    @Child
    private TruffleString.ToJavaStringNode toJavaString;

    public IsMemberRemovableBuiltin() {
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        return library.isMemberRemovable(receiver, toJavaString.execute(member));
    }
}
