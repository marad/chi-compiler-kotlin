...
public class IsMemberReadableBuiltin extends LangInteropBuiltin {
    @Child
    private InteropLibrary library;
    @Child
    private TruffleString.ToJavaStringNode toJavaString;

    public IsMemberReadableBuiltin() {
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        return library.isMemberReadable(receiver, toJavaString.execute(member));
    }
}
